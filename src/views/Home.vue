...
<template>
  <div class="bg-gray-50 pt-6 dark:bg-gray-900 dark:text-purple-50">
    <div class="hero container max-w-screen-xl min-h-screen pb-12 mx-auto">
      <div
        class="h-64 rounded-md overflow-hidden md:bg-cover bg-center mx-auto"
        style="
      ...
      >
        <div
          class="bg-gray-800 bg-opacity-50 flex items-center place-self-center h-full mx-auto"
        >
          <div class="px-10 md:py-8 mx-auto">
            <div class="flex flex-wrap justify-center mx-auto">
              <div
                class="rounded-2xl sm:w-1/2 lg:w-4/12 md:w-4/12 xl:w-4/12 px-12 w-25 h-25 object-cover mx-auto"
              >
                <img
                  src="https://i.pinimg.com/originals/75/92/51/759251683b15dcb54aefff9cd73d095c.jpg"
                  alt="..."
                  class="outline-white rounded-full max-w-full h-auto align-middle place-self-center items-center border-none"
                />
              </div>
            </div>
            <h2
              class="sm:text-5xl md:text-5xl lg:text-5xl xl:text-5xl 2xl:text-5xl text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600 text-center font-extrabold mt-3 text-shadow lg:text-shadow-lg antialiased mx-auto"
            >
            ...
            <router-link to="blog">
              <button
                class="mx-auto dark:text-black flex items-center mt-4 px-3 py-2 text-white text-sm rounded-full font-bold btn-gra"
                id="btn-gra"
              >
                Get Started
                <!-- <RightArrow /> -->
      ...
      <div
        class="max-w-screen-xl px-4 py-12 mx-auto sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between flex flex-wrap"
      >
        <svg class="animate-bounce w-6 h-6 ...">
          <!-- ... -->
        </svg>
        <h2
          class="w-full dark:text-white text-3xl font-extrabold leading-9 tracking-tight text-gray-900 inline-flex items-center sm:text-4xl sm:leading-10"
        >
          Welcome To My Site.
          <svg
        ...
        <div
          class="w-1/2 overflow-hidden font-extrabold text-indigo-600 justify-self-start text-2xl"
        >
          Vite 2.x + Vue 3.x + Tailwind 2.x
        </div>
        <div class="flex lg:flex-shrink-0 mt-0.5">
          <div class="inline-flex rounded-md shadow">
            <router-link
              to="/blog"
              class="px-5 py-3 xs:h-auto text-base font-medium text-white transition duration-150 ease-in-out bg-indigo-600 border border-transparent rounded-md hover:bg-indigo-500 focus:outline-none"
